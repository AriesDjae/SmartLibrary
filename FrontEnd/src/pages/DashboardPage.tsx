...
import { Book, Clock, BookOpen, ArrowUpRight, User } from "lucide-react";
...
const DashboardPage: React.FC = () => {
  ...
  // Mock total users (karena AuthContext tidak menyediakan daftar user)
  const totalUsers = 123; // Ganti dengan data asli jika sudah ada
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">
              Pantau statistik dan aktivitas perpustakaan
            </p>
          </div>
